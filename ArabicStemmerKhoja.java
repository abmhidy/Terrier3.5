...
import org.terrier.terms.Utils.RevisionUtils;
...
public class ArabicStemmerKhoja extends StemmerTermPipeline{
    

     static KhojaStem khoja = null;
      public ArabicStemmerKhoja(TermPipeline _next) {
    	 super(_next);
   ...
   public static void main(String[] args) {
    /*   String [] phrase={"-i","abdo.txt","-o","abo.txt","-l"};
     try {
       Stemming.useStemmer(new ArabicStemmerKhoja(),phrase);
     }
     catch (Exception e) {
       e.printStackTrace();
     }*/
     ArabicStemmerKhoja khoj=new ArabicStemmerKhoja();
     System.out.println(khoj.stem("الدارسين"));
